 ...
 * manages symbols within a program, offering functionalities to define
 * identifiers with their types and kinds, track their indices in scopes (class
 * or subroutine), and retrieve information about variables. This class employs
 * HashMaps to organize symbols based on their scope (class or subroutine),
 * enabling efficient access and management of identifiers within their
 * respective scopes
 */
public class SymbolTable {
    ...
    // running index
    // STATIC & FIELD identifiers have a class scope, while ARG and VAR identifiers
    ...
    // return the kind of the named identifier in the current scope, if the
    // identifier is unknown in current scope, returns NONE
